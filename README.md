...
***2.`Get Session ID` by [`SCANING QR 1`](https://scan-flash-md.onrender.com) if it's slow use [`QR SCANNER 2`](https://king-france.vercel.app) or [`PAIRING CODE 2`](https://flash-sessions.onrender.com/pair)***
