...
**📌DEPLOY ON HEROKU**
   ...
   - ***`Get Session` by [`SCANING QR`](https://flash-md-qr.onrender.com) Or [`PAIRING CODE`](https://replit.com/@franceking1/Flash-Md-Pairing). Then `Go-to Whatapp>Three dots>Linked Devices`***
