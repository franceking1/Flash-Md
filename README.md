...
**📌DEPLOY ON HEROKU**
   ...
   - ***`Get Session` by [`SCANING QR`](https://flash-md-qr.onrender.com) Or [`PAIRING CODE`](https://flash-session-e44e9af121be.herokuapp.com/pair) Then `Go-to Whatapp>Three dots>Linked Devices`***
