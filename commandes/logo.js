...
zokou({nomCom:"marvel",categorie:"Logo",reaction:"🌠"},async(dest,zk,commandeOptions)=>{
  ...
  try{
    ...
    var lien="https://en.ephoto360.com/create-marvel-style-text-effects-online-419.html";
...
zokou({nomCom:"avenger",categorie:"Logo",reaction:"🌠"},async(dest,zk,commandeOptions)=>{
  ...
  try{
    ...
    var lien="https://en.ephoto360.com/create-avengers-style-text-effects-online-427.html";
